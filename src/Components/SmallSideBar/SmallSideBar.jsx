...
const SmallSideBar = ({setDisplay,display}) => {
    const [menu,setMenu]=useState('')
  return (
    <>
            {
                display&&<div className='w-full h-full flex bg-[#001524] flex-col itmes-center'>
                <div className='w-[150px] h-[150px] md:mx-auto flex  justify-center rounded-full overflow-hidden mt-5'>
